...
const ownInitials = ["눅", "샹", "젤", "델", "뽀", "켄", "연"];
 ...
 * 표에 표시할 커플명.
 * [행 멤버][열 멤버] 순서.
 * 각 이니셜(눅·샹·젤·델·뽀·켄·연)을 행+열 순서로 이어붙인 기본값이니,
 * 원하는 조합명으로 자유롭게 바꿔서 쓰시면 돼요.
 */
const pairNames = [
    ["눅눅", "눅샹", "눅젤", "눅성", "눅뽀", "눅켄", "눅연"],
    ["샹눅", "샹샹", "샹젤", "샹민", "샹뽀", "샹켄", "샹갱"],
    ["여눅", "젤샹", "젤젤", "젤민", "여뽀", "젤켄", "젤연"],
    ["성눅", "델샹", "성젤", "델델", "델뽀", "델켄", "델연"],
    ["뽀눅", "뽀샹", "뽀여", "뽀델", "뽀뽀", "뽀켄", "뽀갱"],
    ["켄눅", "켄샹", "켄젤", "켄성", "켄뽀", "켄켄", "켄갱"],
    ["배욱", "연샹", "연젤", "연델", "갱뽀", "갱켄", "연연"]
];
...
const CUSTOM_COLOR_KEY = "cye-custom-colors";
...
const STORAGE_KEY = "cye-nunpes-rps";
const LR_STORAGE_KEY = "cye-lr-rps";
const LR_CELL_COUNT = 12;

/* 행/열 개별 숨기기 상태 (멤버 인덱스 기준, rows/cols 따로 관리) */
const HIDDEN_KEY = "cye-hidden-members";
...
const SELF_PAIR_KEY = "cye-include-selfpair";
...
saveBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        const fileLabel = currentTab === "rps" ? "눈페스_취향표" : "공수_취향표";

        const link = document.createElement("a");
        link.href = currentBlobUrl;
        link.download = `CYE_${fileLabel}.png`;
